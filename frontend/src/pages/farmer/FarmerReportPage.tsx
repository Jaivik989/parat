...
import { ArrowLeft, Bell, Package, Search, Award, AlertTriangle, ChevronRight } from 'lucide-react';
...
const stats = [
  ...
  { label: 'Grade A', value: '72.4%', icon: Award, bg: 'bg-indigo-100', color: 'text-indigo-600' },
...
// Farmer quality reports and analytics page.
    ...
    <div className="max-w-md mx-auto min-h-screen bg-cream px-5 pt-6 pb-10">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-extrabold text-2xl text-primary">Reports</h1>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        <div className="bg-white rounded-2xl p-4 border border-gray-100 flex flex-col items-center">
          ...
          <div
            ...
            style={{ background: 'conic-gradient(#1F5C3D 0% 72.4%, #E5E7EB 72.4% 100%)' }}
          >
            <div className="w-24 h-24 bg-white rounded-full flex flex-col items-center justify-center">
              ...
              <p className="font-extrabold text-lg text-secondary">72.4%</p>
            </div>
          </div>
